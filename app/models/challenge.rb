...
class Challenge < ActiveRecord::Base
  attr_accessible :brand_name, :title, :description, :brand_logo_url, :challenge_reward, :challenge_type, :challenge_location, :brand_description, :challenge_cover_photo
